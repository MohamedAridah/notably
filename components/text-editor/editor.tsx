...
const MainToolbarContent = ({
  ...
  return (
    <>
      ...
      <SaveNoteUpdatesButton editor={editor} noteId={noteId} />
...
interface SaveNoteUpdatesButtonProps {
  noteId: string;
  editor: Editor;
}

const SaveNoteUpdatesButton = ({
  noteId,
  editor,
}: SaveNoteUpdatesButtonProps) => {
...
export function RichTextEditor({ content, noteId }: SimpleEditorProps) {
