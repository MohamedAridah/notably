...
import { ImageUploadNode as ImageUploadNodeComponent } from "@/components/editor/node-styles/image-upload-node/image-upload-node";
 ...
 * @see registry/node-styles/image-upload-node/image-upload-node
 */
